...
public class KUPWorldAsset : IKUPPOIAsset
{
    ...
    {
        var income = 0;
        foreach (var tradecode in World.GetTradeCodes())
        {
    ...
    public KUPWorldAsset(KupPointsOfInterestWorld world, int id)
    {
        ...
        Name = world.SubtypeName + " in " + world.InSystem.Name;
        Location = new KUPLocation(world.InSystem.DisplayX,world.InSystem.DisplayY);
        assetID = id;
    }
