...
public class KUPStationAsset : IKUPPOIAsset
{
    ...
    {
        var income = 0;
        foreach (var tradecode in Station.GetTradeCodes())
        {
    ...
    {
        Station = station;
        Location = new KUPLocation(station.InSystem.DisplayX,station.InSystem.DisplayY);
        Name = station.SubtypeName + " in " + station.InSystem.Name;
        assetID = id;
    }
