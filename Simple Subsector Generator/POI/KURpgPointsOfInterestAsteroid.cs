public class KURPGPointsOfInterestAsteroid: KURPGPointsOfInterest
{
    ...
    public KURPGPointsOfInterestAsteroid(int subtypeRoll, KURPGFilledSystem system) 
        : base(KURPGPoiTypes.Asteroid, subtypeRoll, system)
    {
    }
